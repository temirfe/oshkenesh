...
$news = $db->cache(function ($db) use($content_lang) {
    return $db->createCommand("SELECT id,title,`date`,image FROM news WHERE ru='{$content_lang}' ORDER BY `date` DESC LIMIT 3")->queryAll();
},300);
...
<style type="text/css">
    .main_container {padding: 10px 15px 20px;}
</style>
<div class="site-index">
    <div class="row">
        <div class="col-md-9 col-sm 12">
            <div class="main_news col-sm-8">
                <?php
                $i=0;
                foreach ($news as $n) {
                    if($i==0) {
                    ...
                    else {$visible='display:none;'; $firs_img='';}
            ...
            <div class="col-sm-4 main_news_right">
                <?php foreach($news as $on){
                    ?>
                ...
                <p class="more"><a class="more" href="<?=Yii::getAlias('@web');?>/news"><?=Yii::t('app','All news');?></a></p>
            </div>
            <div class="row main_laws">
                <div class="col-md-4 col-sm-12">
                    ...
                    <p><a class="more" href="<?=Yii::getAlias('@web');?>/legislation"><?=Yii::t('app','All legislation');?></a></p>
                </div>
                <div class="col-md-4 col-sm-12">
                    ...
                    <p><a class="more" href="<?=Yii::getAlias('@web');?>/decree"><?=Yii::t('app','All decrees');?></a></p>
                </div>
                <div class="col-md-4 col-sm-12">
                    ...
                    <p><a class="more" href="<?=Yii::getAlias('@web');?>/bill"><?=Yii::t('app','All bills');?></a></p>
                </div>
            </div>
